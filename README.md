...
### Overview
SINGULARITY FORGE is a meta-skill that designs, validates, upgrades, and hardens other skills. It targets both Web (Next.js, React, TypeScript) and Mobile (Flutter/Dart 3.x, Riverpod) workflows, and enforces a strict multi-gate verification system to keep outputs consistent and production-grade.
...
### Key Capabilities
- Skill scaffolding, validation, upgrades, and comparisons.
...
### סקירה כללית
SINGULARITY FORGE הוא מיומנות-על שמעצבת, מאמתת, משדרגת ומחזקת מיומנויות אחרות. הוא תומך ב־Web (Next.js, React, TypeScript) וב־Mobile (Flutter/Dart 3.x, Riverpod), ומכיל מערכת אימות קפדנית עם שערי איכות לשמירה על תוצרים עקביים ומוכנים לפרודקשן.
...
### יכולות מרכזיות
- יצירה, אימות, שדרוג והשוואה בין מיומנויות.
